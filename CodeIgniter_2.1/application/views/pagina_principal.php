        ...
        //if(isset($admins)){
            ...
            foreach ($admins as $ads) { ?>
             <tr>
                ...
                <td><?= $ads->rut; ?></td>
                <td><?= $ads->contacto ;?></td>
<<<<<<< HEAD:CodeIgniter_2.1/application/views/pagina_principal.php
                <td><a href="javascript:void(0);"onclick="eliminar('<?php base_url('Inicio') ?>index.php/Inicio/eliminar/<? echo $ads->pk; ?>')">Eliminar</a></td>
            </tr>
=======
                <td>
